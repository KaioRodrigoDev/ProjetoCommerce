...
export default function NewProducts() {
  ...
  return (
    <>
      <div>
        <div className="dark:bg-slate-900 dark:text-white min-h-screen md:grid md:grid-cols-1 ">
                  ...
                  <div>
                    ...
                    <div className="mt-1">
                      <textarea
                        ...
                        name="about"
                        rows={3}
                        className="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-1/3 sm:text-sm border border-gray-300 rounded-md"
